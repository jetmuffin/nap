...
func (c *Client) GetStateFromCluster() (*MesosState, error) {
...
func (c *Client) GetStateFromLeader() (*MesosState, error) {
...
func (c *Client) GetStateFromPid(pid *Pid) (*MesosState, error) {
...
func (c *Client) GetStateSummaryFromCluster() (*MesosState, error) {
...
func (c *Client) GetStateSummaryFromLeader() (*MesosState, error) {
...
func (c *Client) GetStateSummaryFromPid(pid *Pid) (*MesosState, error) {
...
func (c *Client) GetSlavesFromCluster() (*MesosState, error) {
...
func (c *Client) GetSlavesFromLeader() (*MesosState, error) {
...
func (c *Client) GetSlavesFromPid(pid *Pid) (*MesosState, error) {
...
func (c *Client) parseStateResponse(resp *http.Response, err error) (*MesosState, error) {
	if err != nil {
		return nil, err
	}
